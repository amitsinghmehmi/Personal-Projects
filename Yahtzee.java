...
public class Yahtzee {
	...
	public static void main(String[] args) throws LineUnavailableException, IOException, UnsupportedAudioFileException {
		...
		while (userMoney >= 0) {
			...
			// Large straight 
			if (dieCount[0] == 1 && dieCount[1] == 1 && dieCount[2] == 1 && dieCount[3] == 1 && dieCount[4] == 1 && dieCount[5] == 0 || 		// 12345
					dieCount[0] == 0 && dieCount[1] == 1 && dieCount[2] == 1 && dieCount[3] == 1 && dieCount[4] == 1 && dieCount[5] == 1) {		// 23456
			...
			// Full house
					...
					dieCount[3] == 3 && dieCount[1] == 2||  // 44422
					dieCount[4] == 3 && dieCount[1] == 2||	// 55522
					dieCount[4] == 3 && dieCount[2] == 2||  // 55533
					dieCount[5] == 3 && dieCount[1] == 2||  // 66622
					dieCount[5] == 3 && dieCount[2] == 2||  // 66633
					dieCount[5] == 3 && dieCount[3] == 2 	// 66644
					) {	
				result = "FULL HOUSE";
